import{j as e,t as C,u as S,v as E,r as m,A as L,R as q}from"./react-vendor-DAyRi5Wp.js";import{f as g,s as f,c as y,o as P}from"./index-yDfKJjKf.js";import{u as v}from"./router-DrInukRP.js";import{T as B}from"./Toast-DkPb5xxS.js";import"./vendor-BbZhGlfF.js";const M=({item:s,productStock:r,loadingStock:x,onQuantityChange:u,onRemove:p})=>{const b=v(),h=x||r!==void 0&&s.quantity>=r;return e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx("div",{className:"flex-shrink-0 w-full sm:w-32 h-32 rounded-lg flex items-center justify-center cursor-pointer border border-black",onClick:()=>b(`/productdetails/${s.id}`),children:e.jsx("img",{src:s.image,alt:s.name,className:"w-28 h-28 object-contain"})}),e.jsxs("div",{className:"flex-grow flex flex-col sm:flex-row justify-between gap-4",children:[e.jsxs("div",{className:"flex flex-col justify-between cursor-pointer",onClick:()=>b(`/productdetails/${s.id}`),children:[e.jsxs("div",{children:[e.jsx("h3",{className:"font-lexend text-xl",children:s.name}),e.jsxs("p",{className:" flex font-lexend text-sm mt-1 text-[#8C8C8C] gap-1",children:[e.jsx("p",{className:"text-[#888888] font-bold",children:"Size:"})," ",s.size]}),e.jsx("p",{className:"font-roboto text-[#8C8C8C] text-base",children:s.description})]}),s.type==="service"?e.jsxs("p",{className:"font-bold text-gray-900 mb-3 text-xl",children:["Starting From AU$",s.price," ",e.jsx("sup",{className:"text-sm",children:"ea"})]}):e.jsx("p",{className:"font-satoshi font-bold text-2xl mt-2 sm:mt-0 text-[#000000]",children:g(s.price)})]}),e.jsxs("div",{className:"flex flex-col justify-between items-start sm:items-end",children:[e.jsx("button",{onClick:()=>p(s.id),className:"text-primary hover:text-red-700",children:e.jsx(C,{size:24,fill:"red",className:""})}),e.jsxs("div",{className:"flex items-center gap-5 bg-[#F0F0F0] rounded-full px-5 py-3 mt-2",children:[e.jsx("button",{onClick:()=>u(s.id,s.quantity-1),className:s.quantity===1?"text-gray-400":"text-black",disabled:s.quantity===1,children:e.jsx(S,{size:20})}),e.jsx("span",{className:"font-satoshi font-medium text-sm w-4 text-center",children:s.quantity}),e.jsx("button",{onClick:()=>u(s.id,s.quantity+1),className:h?"text-gray-400":"text-black",disabled:h,children:e.jsx(E,{size:20})})]})]})]})]})},T=({label:s,value:r,isDiscount:x=!1})=>e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("p",{className:"font-lexend text-xl text-black/60",children:s}),e.jsxs("p",{className:`font-lexend text-xl font-medium ${x?"text-primary font-satoshi font-bold":"text-black"}`,children:[x?"-":"",g(r)]})]}),I=({totals:s})=>{const[r,x]=m.useState("full"),u=v();m.useEffect(()=>{const a=f("selectedPaymentOption","full");x(a)},[]),m.useEffect(()=>{y("selectedPaymentOption",r)},[r]);const b=(()=>{const a=s.subtotal;return r==="full"?a:a*.25})(),h=()=>{const a=f("cartItems",[]);if(!(Array.isArray(a)?a:[]).length){B({message:"Please add at least one item to cart",type:"error"}),u("/tyres");return}y("selectedPaymentOption",r),u("/appointment")};return e.jsxs("div",{className:"bg-white rounded-2xl border border-border-gray p-6 space-y-6 sticky top-8",children:[e.jsx("h2",{className:"font-satoshi font-bold text-2xl",children:"Order Summary"}),e.jsx("div",{className:"space-y-5",children:e.jsx(T,{label:"Subtotal",value:s.subtotal})}),e.jsx("hr",{className:"border-border-gray"}),e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("p",{className:"font-lexend font-medium text-xl",children:"Total"}),e.jsx("p",{className:"font-lexend font-medium text-2xl",children:g(b)})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("p",{className:"font-lexend text-2xl",children:"Payment Options:"}),e.jsxs("div",{className:"grid sm:flex-row sm:items-center gap-4 sm:gap-2",children:[e.jsxs("label",{className:"flex items-center gap-2 cursor-pointer font-lexend text-lg",children:[e.jsx("input",{type:"radio",name:"payment",value:"full",checked:r==="full",onChange:a=>x(a.target.value),className:"w-4 h-4 accent-black"}),"Full Payment"]}),e.jsxs("label",{className:"flex items-center gap-2 cursor-pointer font-lexend text-lg",children:[e.jsx("input",{type:"radio",name:"payment",value:"partial",checked:r==="partial",onChange:a=>x(a.target.value),className:"w-4 h-4 accent-black"}),"Partial Payment (25%)"]})]}),e.jsx("div",{className:"bg-blue-50 p-3 rounded-lg",children:e.jsx("p",{className:"text-sm text-blue-800",children:r==="full"?"You will be charged the full amount.":"You will be charged 25% of the total now, with the remainder payable at the store."})})]}),e.jsxs("button",{onClick:h,className:"w-full bg-primary text-white font-lexend font-semibold text-base py-4 rounded-lg flex items-center justify-center gap-3 hover:bg-red-700 transition-colors",children:["Go to Checkout",e.jsx(L,{size:24})]})]})},A=()=>{const s=v(),[r,x]=m.useState(()=>{const t=f("cartItems",[]);return Array.isArray(t)?t:[]}),[u,p]=m.useState({}),[b,h]=m.useState(!0),[a,w]=m.useState({subtotal:0,discount:0,delivery:15,total:0});m.useEffect(()=>{(async()=>{if(r.length===0){h(!1);return}try{const n=r.map(async l=>{try{const o=await P(l.id);return{id:l.id,stock:o.data.data.stock||0}}catch(o){return console.error(`Error fetching stock for product ${l.id}:`,o),{id:l.id,stock:0}}}),c=await Promise.all(n),i={};c.forEach(({id:l,stock:o})=>{i[l]=o}),p(i)}catch(n){console.error("Error fetching product stocks:",n)}finally{h(!1)}})()},[r]),m.useEffect(()=>{if(!Array.isArray(r)){console.error("Cart items is not an array:",r);return}const t=r.reduce((o,d)=>o+d.price*d.quantity,0),n=t*.2,c=15,i=t-n+c;w({subtotal:t,discount:n,delivery:c,total:i}),y("cartItems",r);const l=r.reduce((o,d)=>o+(d.quantity||1),0);localStorage.setItem("cartCount",String(l)),window.dispatchEvent(new StorageEvent("storage",{key:"cartCount",newValue:String(l)}))},[r]);const j=(t,n)=>{if(n<1)return;const c=u[t];c!==void 0&&n>c||x(i=>i.map(l=>l.id===t?{...l,quantity:n}:l))},k=t=>{const n=document.createElement("div");n.className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50",n.innerHTML=`
    ...
    `,document.body.appendChild(n);const c=n.querySelector("#confirm-btn"),i=n.querySelector("#cancel-btn"),l=n.querySelector("#close-modal-btn"),o=()=>{document.body.removeChild(n)};c.addEventListener("click",()=>{x(d=>d.filter(N=>N.id!==t)),o()}),i.addEventListener("click",o),l.addEventListener("click",o),n.addEventListener("click",d=>{d.target===n&&o()})};return e.jsxs("div",{className:"max-w-screen-2xl mx-auto px-3 sm:px-4 lg:px-8 py-5",children:[e.jsx("h1",{className:"font-lexend font-medium text-3xl text-primary mb-7 px-3",children:"Your Cart"}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-8 items-start",children:[e.jsx("div",{className:"lg:col-span-2 space-y-6",children:e.jsxs("div",{className:"bg-white rounded-2xl border border-border-gray p-6 space-y-6",children:[r.map((t,n)=>e.jsxs(q.Fragment,{children:[e.jsx(M,{item:t,productStock:u[t.id],loadingStock:b,onQuantityChange:j,onRemove:k}),n<r.length-1&&e.jsx("hr",{className:"border-border-gray"})]},t.id)),r.length===0&&e.jsxs("div",{className:"text-center py-8",children:[e.jsx("p",{className:"text-gray-500 text-lg",children:"Your cart is empty"}),e.jsx("button",{onClick:()=>{const t=document.createElement("div");t.className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50",t.innerHTML=`
                    ...
                    `,document.body.appendChild(t);const n=t.querySelector("#tyres-btn"),c=t.querySelector("#wheels-btn"),i=t.querySelector("#services-btn"),l=t.querySelector("#close-modal-btn"),o=()=>{document.body.removeChild(t)};n.addEventListener("click",()=>{s("/tyres"),o()}),c.addEventListener("click",()=>{s("/wheels"),o()}),i.addEventListener("click",()=>{s("/services"),o()}),l.addEventListener("click",o),t.addEventListener("click",d=>{d.target===t&&o()})},className:"w-full bg-primary text-white font-lexend font-semibold text-xl py-4 rounded-lg hover:bg-red-700 transition-colors",children:"Add Another Product"})]})]})}),e.jsx("div",{className:"lg:col-span-1",children:e.jsx(I,{totals:a})})]})]})};function W(){return e.jsx("div",{className:"flex flex-col min-h-screen",children:e.jsx("main",{className:"flex-grow",children:e.jsx(A,{})})})}export{W as default};
