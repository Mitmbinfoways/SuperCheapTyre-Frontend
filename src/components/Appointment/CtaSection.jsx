...
const CtaSection = () => {
  return (
    <section className="max-w-screen-2xl mx-auto px-3 sm:px-4 md:pt-40 lg:px-8 py-8">
      <div className="relative bg-black rounded-3xl text-white min-h-[380px] flex items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 p-4 md:p-12">
          <div className="absolute z-10 order-2 md:order-1 left-0  bottom-1">
            <img
              ...
              className="sm:w-full sm:h-full sm:mx-auto hidden md:block"
            />
          </div>
          <div className="relative z-10 order-1 md:order-2 text-center md:text-left sm:-right-72 sm:-top-24">
        ...
        <img
          ...
          alt="Stack of tyres"
          className="absolute -right-5 -bottom-5 hidden sm:block"
        />
      </div>
    </section>
  );
